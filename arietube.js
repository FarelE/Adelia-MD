...
module.exports = arietube = async (arietube, m, chatUpdate, store) => {
    try {
        ...
        const quoted = m.quoted ? m.quoted : m
		 const ownerNumber = ["6285339189356@s.whatsapp.net"] 
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            case 'sc': {
                ...
                let buttonMessage = {
                    text: `Script : wa.me/6285339189356`,
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'wa.me/6285339189356'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 853-3918-9356'
                                }
                            }, {
                                quickReplyButton: {
...
╔═══❖•ೋ°
╟👨‍👨‍👧‍👧 *Group Official Bot:*
╟https://chat.whatsapp.com/I568SQ1Ytkw5mi7fLTd3MZ
╚═══❖•ೋ°
╔═ *😁 Group Menu*
╟📤 ${prefix}linkgroup
...
╚═════ ▓▓ ࿇`
                let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://chat.whatsapp.com/I568SQ1Ytkw5mi7fLTd3M'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
